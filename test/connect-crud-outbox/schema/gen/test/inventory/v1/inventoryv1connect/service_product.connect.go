...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/labset/clarity-protobuf-tools/test/connect-crud-outbox/schema/gen/test/inventory/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProductServiceName = "test.inventory.v1.ProductService"
)
...
const (
	...
	// CreateProduct RPC.
	ProductServiceCreateProductProcedure = "/test.inventory.v1.ProductService/CreateProduct"
	// ProductServiceGetProductProcedure is the fully-qualified name of the ProductService's GetProduct
	// RPC.
	ProductServiceGetProductProcedure = "/test.inventory.v1.ProductService/GetProduct"
	// ProductServiceListProductsProcedure is the fully-qualified name of the ProductService's
	// ListProducts RPC.
	ProductServiceListProductsProcedure = "/test.inventory.v1.ProductService/ListProducts"
	// ProductServiceUpdateProductProcedure is the fully-qualified name of the ProductService's
	// UpdateProduct RPC.
	ProductServiceUpdateProductProcedure = "/test.inventory.v1.ProductService/UpdateProduct"
	// ProductServiceDeleteProductProcedure is the fully-qualified name of the ProductService's
	// DeleteProduct RPC.
	ProductServiceDeleteProductProcedure = "/test.inventory.v1.ProductService/DeleteProduct"
)

// ProductServiceClient is a client for the test.inventory.v1.ProductService service.
...
// NewProductServiceClient constructs a client for the test.inventory.v1.ProductService service. By
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	productServiceMethods := v1.File_test_inventory_v1_service_product_proto.Services().ByName("ProductService").Methods()
...
// CreateProduct calls test.inventory.v1.ProductService.CreateProduct.
...
// GetProduct calls test.inventory.v1.ProductService.GetProduct.
...
// ListProducts calls test.inventory.v1.ProductService.ListProducts.
...
// UpdateProduct calls test.inventory.v1.ProductService.UpdateProduct.
...
// DeleteProduct calls test.inventory.v1.ProductService.DeleteProduct.
...
// ProductServiceHandler is an implementation of the test.inventory.v1.ProductService service.
...
func NewProductServiceHandler(svc ProductServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/test.inventory.v1.ProductService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProductServiceHandler) CreateProduct(context.Context, *connect.Request[v1.CreateProductRequest]) (*connect.Response[v1.CreateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.inventory.v1.ProductService.CreateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) GetProduct(context.Context, *connect.Request[v1.GetProductRequest]) (*connect.Response[v1.GetProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.inventory.v1.ProductService.GetProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) ListProducts(context.Context, *connect.Request[v1.ListProductsRequest]) (*connect.Response[v1.ListProductsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.inventory.v1.ProductService.ListProducts is not implemented"))
}
...
func (UnimplementedProductServiceHandler) UpdateProduct(context.Context, *connect.Request[v1.UpdateProductRequest]) (*connect.Response[v1.UpdateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.inventory.v1.ProductService.UpdateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) DeleteProduct(context.Context, *connect.Request[v1.DeleteProductRequest]) (*connect.Response[v1.DeleteProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.inventory.v1.ProductService.DeleteProduct is not implemented"))
}
